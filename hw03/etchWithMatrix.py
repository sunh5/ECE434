...
def drawGrid():
    ...
    global clearRed
    global reverseRed
    global temp; global temp2
    global tempReverse; global tempReverse2
    global addFlag
    global redLabel
    if value == "w":
        addFlag = 0;
        ...
        grid[curX][curY] = "*"
        # print("temp" + str(temp) + "  tempReverse" + str(tempReverse))
        # if (temp == curX) and (tempReverse[curY-1] == reverseRed[curY-1]):
        #     reverseRed[curY-1] = reverseRed[curY-1]
        # else:
        #     reverseRed[curY-1] += reverse[curX-1]
        # if (reverseRed[curY-1]):
        #     reverseRed[curY-1] += reverse[curX-1]
        #     addFlag = 1;
        if redLabel[curX-1][curY-1] != 1:
            reverseRed[curY-1] += reverse[curX-1]
